...
@Index('ix_statistics_short_term_start_ts', ['startTs'], {})
@Entity('statistics_short_term', { schema: 'public' })
export class StatisticsShortTerm {
  ...
  @ManyToOne(
    () => StatisticsMeta,
    (statisticsMeta) => statisticsMeta.statisticsShortTerms,
    { onDelete: 'CASCADE' },
  )
